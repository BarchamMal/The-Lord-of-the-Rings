...
public class ModMisc {
    ...
    public static final BlockSetType APPLE_SET_TYPE = BlockSetTypeBuilder.copyOf(BlockSetType.OAK).build(Identifier.of(TLOTRMB, "apple"));
    public static final BlockSetType PINE_SET_TYPE = BlockSetTypeBuilder.copyOf(BlockSetType.OAK).build(Identifier.of(TLOTRMB, "pine"));
    ...
    public static final WoodType APPLE = new WoodTypeBuilder().register(Identifier.of(TLOTRMB, "apple"), APPLE_SET_TYPE);
    public static final WoodType PINE = new WoodTypeBuilder().register(Identifier.of(TLOTRMB, "pine"), PINE_SET_TYPE);
    ...
    public static final SaplingGenerator APPLE_SAPLING_GENERATOR = new SaplingGenerator("apple", Optional.empty(), Optional.of(APPLE_TREE), Optional.of(APPLE_BEE_TREE));
    public static final SaplingGenerator PINE_SAPLING_GENERATOR = new SaplingGenerator("pine",  Optional.of(PINE_MEGA_TREE), Optional.of(PINE_TREE), Optional.empty());
